                        ...
                        >
                            ...
                            <div className="flex items-center mt-4 justify-between">
                                <input
                                    type="number"
                                    min="1"
                                    max={product.quantity} // Restrict the input to available stock
                                    defaultValue="1"
                                    className="border w-12 p-1 text-center rounded-md mr-2"
                                    onChange={(e) => {
                                        if (e.target.value > product.quantity) {
                                            alert(`You can't request more than ${product.quantity} kg.`);
                                            e.target.value = product.quantity; // Reset to max if exceeded
                                        }
                                    }}
                                />
